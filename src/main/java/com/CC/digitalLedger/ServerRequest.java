...
////    }
//
//    public String getBalance(String publicKey) throws IOException, InterruptedException { //returns balance for specific user
...
////        ServerRequest server = new ServerRequest("https://a856-192-70-253-78.ngrok.i0");
